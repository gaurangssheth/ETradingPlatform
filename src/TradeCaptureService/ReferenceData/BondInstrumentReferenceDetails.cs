...
{
    public sealed record BondInstrumentReferenceDetails : IInstrumentReferenceDetails
    {
        public BondInstrumentReferenceDetails(
            Guid instrumentId,
            string isin,
            string issuer,
        ...
        public CurrencyCode NotionalCurrency => DenominationCurrency;
    }
}
